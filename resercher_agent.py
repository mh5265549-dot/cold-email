...
resercher_agent = Agent(
    ...
    goal = "research information about the milkyway galaxy ",
    backstory = "you are a great resercher who studies about the milkyway galaxy but people didnt take any interest in it",
    llm = llm,
    tools = [search_tool]
)
...
reserchers_task = Task(
    description = "research about the milkyway galaxy and provide the real information about milkyway galaxy",
    expected_output = "a useful information about milkyway galaxy so that if people read this information so they started taking interest in it",
